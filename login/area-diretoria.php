...
<head>
	...
	<title>Centro Acadêmico de Computação UEL</title>
...
<body id="area-membro">
	...
	<div class="container">
		<div class="box">
			<div class="lado-esquerdo-inventario">
				<img src="https://i.imgur.com/tyWsY6D.jpg">
				<span style="color: grey;">*imagem do CAFIS até consiguirmos <br>uma do CACOMP</span>
			</div>
			<div class="lado-direito-inventario">
	...
	<section id="feedback">
			...
			<br>
			<br>
			<p><i class="fas fa-comments fa-2x"></i><br> <br>Página em desenvolvimento,<br>Voltaremos em breve!</p>
	</section>
	<footer >
